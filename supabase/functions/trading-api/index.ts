  ...
  try {
    ...
    switch (path) {
      ...
      case '/start_live_trading':
        await logActivity(supabaseClient, 'TRADING', 'LIVE_START', 'Starting live trading');
        ...
        await logActivity(supabaseClient, 'TRADING', 'LIVE_STARTED', `Live trading started for ${liveSymbols.length} symbols`, 'TRADING', 'success');
      ...
      case '/stop_live_trading':
        await logActivity(supabaseClient, 'TRADING', 'LIVE_STOP', 'Stopping live trading');
        ...
        await logActivity(supabaseClient, 'TRADING', 'LIVE_STOPPED', 'Live trading stopped successfully', 'TRADING', 'info');
